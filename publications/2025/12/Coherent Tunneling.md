...
1.  **Microtubule Hamiltonian ($H_{MT}$):**
...
2.  **Synaptic Barrier Hamiltonian ($H_{syn}$):**
...
3.  **Interaction Hamiltonian ($H_{int}$):**
...
1.  **Effective Noise Temperature ($N_{eff}$):**
...
Grigolini, P., et al. (2025). Biophotons and Emergence of Quantum Coherence—A Diffusion Entropy Analysis. *Entropy*, *27*(5), 554.
...
Khan, S., Wiest, M. C., et al. (2024). Microtubule-Stabilizer Epothilone B Delays Anesthetic-Induced Unconsciousness in Rats. *eNeuro*, *11*(2), ENEURO-24.2024.

Landauer, R. (1961). Irreversibility and heat generation in the computing process. *IBM Journal of Research and Development*, *5*(3), 183-191.

Lundholm, I., Rodilla, H., Wahlgren, N. Y., et al. (2015). Terahertz radiation induces non-thermal structural changes associated with Fröhlich condensation in a protein crystal. *Structural Dynamics*, *2*(5), 054702.

Matt, E., Mitterwallner, M., Beisteiner, R., et al. (2025). Ultrasound Neuromodulation With Transcranial Pulse Stimulation in Alzheimer Disease: A Randomized Clinical Trial. *JAMA Network Open*, *8*(2), e2459170.
...
Nardecchia, I., et al. (2018). Out-of-equilibrium catalysis of chemical reactions by electronic or vibrational strong coupling. *Physical Review X*, *8*(3), 031061.

Pollack, G. H. (2013). *The Fourth Phase of Water: Beyond Solid, Liquid, and Vapor*. Ebner & Sons.

Prigogine, I., & Nicolis, G. (1977). *Self-Organization in Nonequilibrium Systems: From Dissipative Structures to Order through Fluctuations*. Wiley-Interscience.

Pudney, C. R., Lane, R. S., Fielding, A. J., Maglia, G., Hildebrandt, P., & Scrutton, N. S. (2013). Hydrogen tunneling links protein dynamics to enzyme catalysis. *Proceedings of the National Academy of Sciences*, *110*(15), 5903-5908.

Reimers, J. R., et al. (2009). Weak, strong, and coherent regimes of Fröhlich condensation in biological systems. *Proceedings of the National Academy of Sciences*, *106*(11), 4219-4224.

Rizo, J., & Xu, J. (2015). The synaptic vesicle release machinery. *Annual Review of Biophysics*, *44*, 339-367.

Rosa, L., & Faber, J. (2004). Decoherence-free subspaces. *Physical Review A*, *70*(3), 032318.
...
Tegmark, M. (2000). Why the brain is probably not a quantum computer. *Physical Review E*, *61*(4), 4194.

Wu, T. M., & Austin, S. (1978). Bose-Einstein condensation in biological systems. *Journal of Theoretical Biology*, *71*(2), 209-214.
