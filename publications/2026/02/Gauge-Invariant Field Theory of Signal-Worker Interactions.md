...
| System Size ($N$ Workers) | LCI Value (Complexity Index) | Error Suppression Factor ($e^{-LCI}$) |
| :--- | :--- | :--- |
| 10 | 13.7 | $1.1 \times 10^{-6}$ |
| 50 | 68.7 | $1.4 \times 10^{-30}$ |
| 100 | 137.5 | $1.9 \times 10^{-60}$ |
| 500 | 687.3 | $< 10^{-100}$ |
| 1000 | 1374.5 | $\approx 0$ (Topologically Protected) |
...
| Parameter | Eigenvalue ($\lambda$) | Classification | Physical Interpretation |
| :--- | :--- | :--- | :--- |
| Hopping ($t$) | $0.0$ | Marginal | Energy scale reference |
| Interaction ($U$) | $-0.10$ | Irrelevant | Stable fixed point (Universality) |
| Signal ($g$) | $-0.20$ | Irrelevant | Stable fixed point (Universality) |
