...
2.  **The Principle of Signal Dynamics:** The substrate’s dynamics must be controlled by engineering its environmental modes (**Signals**) to guide the functional excitations (**Workers**).
3.  **The Principle of Static Control:** The substrate’s properties should be programmed primarily through static, geometric parameters (**Geometry** and **Pressure**) to ensure thermodynamic efficiency and stability.
